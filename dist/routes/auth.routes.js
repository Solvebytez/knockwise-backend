 ...
 */
router.post('/register', (0, validator_1.validate)(validators_1.registerValidation), auth_controller_1.register);
/**
 * @openapi
 * /api/auth/login:
 *   post:
 ...
 */
router.post('/login', (0, validator_1.validate)(validators_1.loginValidation), auth_controller_1.login);
/**
 * @openapi
 * /api/auth/refresh:
 *   post:
 ...
 */
router.post('/logout', (0, validator_1.validate)(validators_1.logoutValidation), auth_controller_1.logout);
/**
 * @openapi
 * /api/auth/logout-all:
 *   post:
